...
const Card = (props: IAttributes): JSX.Element => {
  ...
  return (
    <div className="min-w-72 w-72 snap-center rounded-lg bg-white shadow-md">
      ...
      <div className="flex h-80 flex-col justify-between px-5 pt-4 pb-5">
        <div className="space-y-2">
          <div className="text-xs text-gray-500">{studentsCount}人一起學習</div>
        ...
        <div>
          <div className="space-x-2 text-sm leading-6">
            <span className="text-red-500">{currencySymbol + salePrice}</span>
            <span className="text-xs text-gray-400 line-through">定價 {currencySymbol + listPrice}</span>
          </div>

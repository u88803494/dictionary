...
const Navbar: FC = () => {
  ...
  return (
    <nav className="relative h-16 flex justify-between px-6 bg-white shadow-md">
      <div className="flex items-center">
        <div className="text-3xl text-gray-800 font-bold whitespace-nowrap hover:text-gray-800">
          新典
        </div>
        <div
          className={`absolute top-16 right-0 bg-white shadow-md ${navigationMdStyle} ${navigationDisplay}`}
        >
